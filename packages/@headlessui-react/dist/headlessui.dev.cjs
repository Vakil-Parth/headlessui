...
function useSyncRefs(...refs) {
  ...
  return refs.every(
    (ref) => ref == null || (ref == null ? void 0 : ref[Optional])
  ) ? void 0 : syncRefs;
}
...
function adjustOrderedState(state2, adjustment = (i) => i) {
  ...
  let sortedOptions = sortByDomNode(
    adjustment(state2.options.slice()),
...
function ComboboxFn(props, ref) {
  ...
  let isSelected = (0, import_react17.useCallback)(
    ...
    () => ({
      ...
      get activeOptionIndex() {
        if (defaultToFirstOption.current && state2.activeOptionIndex === null && state2.options.length > 0) {
          let localActiveOptionIndex = state2.options.findIndex(
            (option) => !option.dataRef.current.disabled
          );
          if (localActiveOptionIndex !== -1) {
  ...
  return <ComboboxActionsContext.Provider value={actions}><ComboboxDataContext.Provider value={data}><OpenClosedProvider value={match(data.comboboxState, {
    [0 /* Open */]: 0 /* Open */,
    [1 /* Closed */]: 1 /* Closed */
  })}>
    {name != null && value != null && objectToFormEntries({ [name]: value }).map(([name2, value2]) => <Hidden features={4 /* Hidden */} {...compact({
      key: name2,
      as: "input",
      type: "hidden",
      hidden: true,
  ...
  </OpenClosedProvider></ComboboxDataContext.Provider></ComboboxActionsContext.Provider>;
}
...
var Input = forwardRefWithAs(function Input2(props, ref) {
  ...
  function updateInputAndNotify(newValue) {
    var _a3;
    ...
    (_a3 = descriptor == null ? void 0 : descriptor.set) == null ? void 0 : _a3.call(input, newValue);
  ...
  useWatch(
    ([currentValue2, state2], [oldCurrentValue, oldState]) => {
...
var FocusTrap = Object.assign(
  forwardRefWithAs(function FocusTrap2(props, ref) {
    ...
    return <>
      {Boolean(features & 4 /* TabLock */) && <Hidden as="button" type="button" onFocus={handleFocus} features={2 /* Focusable */} />}
      {render({
        ourProps,
        theirProps,
...
var Group = forwardRefWithAs(function Group2(props, ref) {
  ...
  return <PortalGroupContext.Provider value={target}>{render({
    ourProps,
    theirProps,
  ...
  return [
    ...
    (0, import_react26.useMemo)(() => {
      return function DescriptionProvider(props) {
        ...
        return <DescriptionContext.Provider value={contextBag}>{props.children}</DescriptionContext.Provider>;
      };
    }, [setDescriptionIds])
  ];
}
...
var DialogRoot = forwardRefWithAs(function Dialog(props, ref) {
  ...
  useOutsideClick(
    () => {
      ...
      let rootContainers = Array.from(
        (_a2 = ownerDocument == null ? void 0 : ownerDocument.querySelectorAll("body > *, [data-headlessui-portal]")) != null ? _a2 : []
      ).filter((container) => {
  ...
  let contextBag = (0, import_react28.useMemo)(
    () => [{ dialogState, close, setTitleId }, state2],
  ...
  return <StackProvider type="Dialog" enabled={dialogState === 0 /* Open */} element={internalDialogRef} onUpdate={useEvent((message, type, element) => {
    if (type !== "Dialog")
      return;
    match(message, {
      [0 /* Add */]() {
    ...
    <ForcePortalRoot force={true}><Portal2><DialogContext.Provider value={contextBag}><Portal2.Group target={internalDialogRef}><ForcePortalRoot force={false}><DescriptionProvider slot={slot} name="Dialog.Description"><FocusTrap initialFocus={initialFocus} containers={containers} features={enabled ? match(position, {
      parent: FocusTrap.features.RestoreFocus,
      leaf: FocusTrap.features.All & ~FocusTrap.features.FocusLock
    }) : FocusTrap.features.None}>{render({
      ourProps,
      theirProps,
      slot,
      ...
      name: "Dialog"
    })}</FocusTrap></DescriptionProvider></ForcePortalRoot></Portal2.Group></DialogContext.Provider></Portal2></ForcePortalRoot>
    <Hidden features={4 /* Hidden */} ref={mainTreeNode} />
  </StackProvider>;
});
...
var Backdrop = forwardRefWithAs(function Backdrop2(props, ref) {
  ...
  return <ForcePortalRoot force><Portal2>{render({
    ourProps,
    theirProps,
    slot,
    defaultTag: DEFAULT_BACKDROP_TAG,
    name: "Dialog.Backdrop"
  })}</Portal2></ForcePortalRoot>;
});
...
var DisclosureRoot = forwardRefWithAs(function Disclosure(props, ref) {
  ...
  return <DisclosureContext.Provider value={reducerBag}><DisclosureAPIContext.Provider value={api}><OpenClosedProvider value={match(disclosureState, {
    [0 /* Open */]: 0 /* Open */,
    [1 /* Closed */]: 1 /* Closed */
  })}>{render({
    ourProps,
    ...
    name: "Disclosure"
  })}</OpenClosedProvider></DisclosureAPIContext.Provider></DisclosureContext.Provider>;
});
...
var Button3 = forwardRefWithAs(function Button4(props, ref) {
  ...
  let slot = (0, import_react29.useMemo)(
    () => ({ open: state2.disclosureState === 0 /* Open */ }),
    [state2]
  );
...
var Panel3 = forwardRefWithAs(function Panel4(props, ref) {
  ...
  let slot = (0, import_react29.useMemo)(
    () => ({ open: state2.disclosureState === 0 /* Open */, close }),
    [state2, close]
  );
  let theirProps = props;
  let ourProps = {
  ...
  return <DisclosurePanelContext.Provider value={state2.panelId}>{render({
    ourProps,
    theirProps,
    slot,
...
var ListboxRoot = forwardRefWithAs(function Listbox(props, ref) {
  ...
  useIsoMorphicEffect(
    () => dispatch({ type: 3 /* SetOrientation */, orientation }),
    [orientation]
  );
  useOutsideClick(
  ...
  let slot = (0, import_react30.useMemo)(
    () => ({ open: listboxState === 0 /* Open */, disabled, value }),
    [listboxState, disabled, value]
  );
  let ourProps = { ref: listboxRef };
  return <ListboxContext.Provider value={reducerBag}><OpenClosedProvider value={match(listboxState, {
    [0 /* Open */]: 0 /* Open */,
    [1 /* Closed */]: 1 /* Closed */
  })}>
    {name != null && value != null && objectToFormEntries({ [name]: value }).map(([name2, value2]) => <Hidden features={4 /* Hidden */} {...compact({
  ...
  </OpenClosedProvider></ListboxContext.Provider>;
});
...
var Label3 = forwardRefWithAs(function Label4(props, ref) {
  ...
  let slot = (0, import_react30.useMemo)(
    () => ({ open: state2.listboxState === 0 /* Open */, disabled: state2.disabled }),
    [state2]
  );
  let theirProps = props;
  let ourProps = { ref: labelRef, id: id2, onClick: handleClick };
...
var MenuRoot = forwardRefWithAs(function Menu(props, ref) {
  ...
  return <MenuContext.Provider value={reducerBag}><OpenClosedProvider value={match(menuState, {
    [0 /* Open */]: 0 /* Open */,
    [1 /* Closed */]: 1 /* Closed */
  })}>{render({
    ourProps,
    ...
    name: "Menu"
  })}</OpenClosedProvider></MenuContext.Provider>;
});
...
var PopoverRoot = forwardRefWithAs(function Popover(props, ref) {
  ...
  let registerBag = (0, import_react32.useMemo)(
    () => ({ buttonId, panelId, close: () => dispatch({ type: 1 /* ClosePopover */ }) }),
  ...
  let api = (0, import_react32.useMemo)(
    () => ({ close, isPortalled }),
    [close, isPortalled]
  );
  ...
  return <PopoverContext.Provider value={reducerBag}><PopoverAPIContext.Provider value={api}><OpenClosedProvider value={match(popoverState, {
    [0 /* Open */]: 0 /* Open */,
    [1 /* Closed */]: 1 /* Closed */
  })}>{render({
    ourProps,
    ...
    name: "Popover"
  })}</OpenClosedProvider></PopoverAPIContext.Provider></PopoverContext.Provider>;
});
...
var Button9 = forwardRefWithAs(function Button10(props, ref) {
  ...
  let buttonRef = useSyncRefs(
    internalButtonRef,
    ref,
    isWithinPanel ? null : (button) => button && dispatch({ type: 2 /* SetButton */, button })
  );
  ...
  return <>
    ...
    {visible && !isWithinPanel && isPortalled && <Hidden id={sentinelId} features={2 /* Focusable */} as="button" type="button" onFocus={handleFocus} />}
  </>;
});
...
var Panel5 = forwardRefWithAs(function Panel6(props, ref) {
  ...
  let slot = (0, import_react32.useMemo)(
    () => ({ open: state2.popoverState === 0 /* Open */, close }),
    [state2, close]
  );
  let ourProps = {
    ref: panelRef,
  ...
  return <PopoverPanelContext.Provider value={state2.panelId}>
    {visible && isPortalled && <Hidden id={beforePanelSentinelId} ref={state2.beforePanelSentinel} features={2 /* Focusable */} as="button" type="button" onFocus={handleBeforeFocus} />}
    {render({
      ourProps,
      theirProps,
      slot,
    ...
    {visible && isPortalled && <Hidden id={afterPanelSentinelId} ref={state2.afterPanelSentinel} features={2 /* Focusable */} as="button" type="button" onFocus={handleAfterFocus} />}
...
var Group3 = forwardRefWithAs(function Group4(props, ref) {
  ...
  let theirProps = props;
  let ourProps = { ref: groupRef };
  return <PopoverGroupContext.Provider value={contextBag}>{render({
    ourProps,
    theirProps,
    slot,
...
var LabelContext = (0, import_react34.createContext)(
  null
);
...
var RadioGroupRoot = forwardRefWithAs(function RadioGroup(props, ref) {
  ...
  let [value, onChange] = useControllable(controlledValue, controlledOnChange, defaultValue);
  let firstOption = (0, import_react35.useMemo)(
    () => options.find((option) => {
  ...
  let containsCheckedOption = (0, import_react35.useMemo)(
  ...
  return <DescriptionProvider name="RadioGroup.Description"><LabelProvider name="RadioGroup.Label"><RadioGroupContext.Provider value={api}>
    {name != null && value != null && objectToFormEntries({ [name]: value }).map(([name2, value2]) => <Hidden features={4 /* Hidden */} {...compact({
      key: name2,
      as: "input",
      type: "radio",
  ...
  </RadioGroupContext.Provider></LabelProvider></DescriptionProvider>;
});
...
var Option5 = forwardRefWithAs(function Option6(props, ref) {
  ...
  useIsoMorphicEffect(
    () => registerOption({ id: id2, element: internalOptionRef, propsRef }),
    [id2, registerOption, internalOptionRef, props]
  );
  let handleClick = useEvent((event) => {
    var _a2;
    if (isDisabledReactIssue7711(event.currentTarget))
  ...
  return <DescriptionProvider name="RadioGroup.Description"><LabelProvider name="RadioGroup.Label">{render({
    ourProps,
    theirProps,
    slot,
    defaultTag: DEFAULT_OPTION_TAG3,
    name: "RadioGroup.Option"
  })}</LabelProvider></DescriptionProvider>;
});
...
function Group5(props) {
  ...
  let ourProps = {};
  let theirProps = props;
  return <DescriptionProvider name="Switch.Description"><LabelProvider name="Switch.Label" props={{
    onClick() {
      if (!switchElement)
        return;
      switchElement.click();
  ...
  }}><GroupContext.Provider value={context}>{render({
    ourProps,
    theirProps,
    defaultTag: DEFAULT_GROUP_TAG3,
    name: "Switch.Group"
  })}</GroupContext.Provider></LabelProvider></DescriptionProvider>;
}
...
var SwitchRoot = forwardRefWithAs(function Switch(props, ref) {
  ...
  return <>
    {name != null && checked && <Hidden features={4 /* Hidden */} {...compact({
      as: "input",
      type: "checkbox",
      hidden: true,
      readOnly: true,
...
function FocusSentinel({ onFocus }) {
  ...
  if (!enabled)
    return null;
  return <Hidden as="button" type="button" features={2 /* Focusable */} onFocus={(event) => {
    event.preventDefault();
    let frame;
    let tries = 50;
...
var TabsSSRContext = (0, import_react38.createContext)(
  null
);
...
var Tabs = forwardRefWithAs(function Tabs2(props, ref) {
  ...
  let tabsData = (0, import_react38.useMemo)(
    () => ({ orientation, activation, ...state2 }),
    [orientation, activation, state2]
  );
  ...
  return <TabsSSRContext.Provider value={SSRCounter}><TabsActionsContext.Provider value={tabsActions}><TabsDataContext.Provider value={tabsData}>
    {tabsData.tabs.length <= 0 && <FocusSentinel onFocus={() => {
      var _a2, _b;
  ...
  </TabsDataContext.Provider></TabsActionsContext.Provider></TabsSSRContext.Provider>;
});
    ...
    if (false) {
      ...
      listeners.push(
        d.addEventListener(node, "transitionrun", (event) => {
          ...
          listeners.splice(0).forEach((dispose) => dispose());
          listeners.push(
            d.addEventListener(node, "transitionend", (event2) => {
...
var TransitionChild = forwardRefWithAs(function TransitionChild2(props, ref) {
  ...
  return <NestingContext.Provider value={nesting}><OpenClosedProvider value={match(state2, {
  ...
  })}</OpenClosedProvider></NestingContext.Provider>;
});
var TransitionRoot = forwardRefWithAs(function Transition(props, ref) {
  ...
  let transitionBag = (0, import_react39.useMemo)(
    () => ({ show, appear, initial }),
    [show, appear, initial]
  );
  (0, import_react39.useEffect)(() => {
  ...
  return <NestingContext.Provider value={nestingBag}><TransitionContext.Provider value={transitionBag}>{render({
    ourProps: {
      ...sharedProps,
    ...
    visible: state2 === "visible" /* Visible */,
    name: "Transition"
  })}</TransitionContext.Provider></NestingContext.Provider>;
});
var Child = forwardRefWithAs(function Child2(props, ref) {
  ...
  return <>{!hasTransitionContext && hasOpenClosedContext ? <TransitionRoot ref={ref} {...props} /> : <TransitionChild ref={ref} {...props} />}</>;
});
